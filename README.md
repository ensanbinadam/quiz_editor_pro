...
4.  افتح المتصفح على الرابط الذي يظهر لك (غالباً `http://localhost:3000`).
...
4.  Open your browser at the shown URL (usually `http://localhost:3000`).
...
<br>
_Educational Interactive Forum - Saudi Arabia_
